...
class FlyffCharacterController extends Controller
{
    ...
    {
        $characters = FlyffCharacter::with(['flyffAccount', 'guild'])->orderBy('TotalPlayTime', 'desc')->paginate(50);
    ...
    public function shop_update_character(Request $request)
    {
        ...
        return redirect()->back()->with('success', trans('flyff::messages.character-changed'));
    }
}
